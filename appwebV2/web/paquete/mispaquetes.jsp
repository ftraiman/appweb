...
<%
    ...
    String pagina = "Mis Paquetes";

    UsuarioDTO usuarioSession = (UsuarioDTO) request.getSession().getAttribute("usuario");
    if (usuarioSession == null || !Constantes.ARTISTA.equalsIgnoreCase(usuarioSession.getTipo())) {
        response.sendRedirect("/webV2/principal/index.jsp");
        return;
    }

    List<PaqueteDTO> paquetes = ServletPaquete.getPaquetesPorIdUsuario(usuarioSession.getId());
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <a href="/webV2/paquete/alta.jsp" class="btn btn-youtube">Crear nuevo Paquete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="/webV2/paquete/detalle.jsp?idPaquete=<%=idPaquete%>">Ver detalle</a> / 
                                                            <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="/webV2/paquete/agregarespectaculo.jsp?idPaquete=<%=idPaquete%>">Agregar Espectáculo</a>
                                                        </td>
                                                    </tr>
                                                    <%  }
                                                        }%>
