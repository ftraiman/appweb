                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                                        <div class="border-radius-lg">
                                            <img src="/webV2/imagenes?carpeta=paquetes&archivo=<%=paquete.getImagen()%>" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl" style="height: 200px ">
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            <a href="/webV2/espectaculo/detalle.jsp?idEspectaculo=<%=espectaculo.getId()%>" class="text-dark font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                                Más información
                                                            </a>
                                                        </td>
                                                    </tr>
