    ...
    <body class="g-sidenav-show  bg-gray-100">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
            ...
            <div class="container-fluid py-4">
                <form role="form" method="POST" action="/web/espectaculo/consulta.jsp">
                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="d-flex flex-column h-50">
                                            ...
                                            <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="/web/espectaculo/detalle.jsp?idEspectaculo=<%=idEspectaculo%>">
                                                Ver detalles
                                    ...
                                    <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                                        <div class="border-radius-lg">
                                            <img src="/web/imagenes?carpeta=espectaculos&archivo=<%=imagen%>" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl" style="height: 200px ">
                                        </div>
                                    </div>
                                </div>
                                <div class="card mb-4">
